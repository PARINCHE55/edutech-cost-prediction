...
df = pd.read_csv("F:/Projects/EduTech Product Cost Prediction/2/collected data.csv")
df.info()
...
df["Practice_Assignments"] = pd.DataFrame(mode_imputer.fit_transform(df[["Practice_Assignments"]]))
